...
Incomplete: No specs found
Randomized with seed 34216 (jasmine --random=true --seed=34216)
...
Teste_000@Tempcomp MINGW32 ~ (master)
$ git push <https://github.com/lizchiduku/Elizabeth.Chiduku_TDD_Jasmine.git>
bash: syntax error near unexpected token `newline'

Teste_000@Tempcomp MINGW32 ~ (master)
$ git push http://github.com/lizchiduku/Elizabeth.Chiduku_TDD_Jasmine.git
fatal: The current branch master has no upstream branch.
To push the current branch and set the remote as upstream, use

    git push --set-upstream http://github.com/lizchiduku/Elizabeth.Chiduku_TDD_Jasmine.git master
